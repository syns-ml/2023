...
\item Page limit: The main body of the paper has to be fitted to $4$ pages, excluding references and appendices; the space for the latter two is not limited. For the final version of the paper, authors can add one extra page to the main body.
...
SynS \& ML uses double-blind review, so author information must not appear. If
